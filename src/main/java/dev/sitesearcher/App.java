...
public class App {
	...
	public static final int MAX_CONSUMER_THREADS = 20;
	public static final String DEFAULT_URLS_FILE = "urls.txt";
	public static final String REGEX = "\\b(today|outside|more)\\b";
